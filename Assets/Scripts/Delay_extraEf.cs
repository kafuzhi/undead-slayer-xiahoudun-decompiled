...
// Type: Delay_extraEf
    ...
    IL_0013: nop
    IL_0014: nop
    IL_14C5F519: switch (87129408 cases)
    }

    private void Update() {
    IL_0000: ldarg.0
    IL_0001: dup
    IL_0006: ldfld 0x04000531
    IL_000B: call 0x0A000024
    IL_000C: IL_59
    IL_0011: stfld 0x04000531
    IL_0012: ldarg.0
    IL_0017: ldfld 0x04000531
    IL_0018: IL_22
    IL_0019: nop
    IL_001A: nop
    IL_001B: nop
