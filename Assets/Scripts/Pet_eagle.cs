...
// Type: Pet_eagle
    ...
    IL_000B: stfld 0x0400085A
    IL_000C: ldarg.0
    IL_000D: ldarg.0
    IL_0012: call 0x0A00002A
    IL_0017: stfld 0x04000860
    IL_0018: ldarg.0
    ...
    IL_0026: nop
    IL_0027: stloc.0
    IL_002C: stfld 0x04000850
    IL_002D: ret
    }

    public void OnEnable() {
    IL_0000: ldarg.0
    IL_0005: ldstr 0x7000004B
    IL_0006: IL_22
    IL_0007: IL_CD
    IL_0008: IL_CC
    IL_0009: IL_CC
    ...
    private void Start() {
    IL_0000: ldarg.0
    IL_0005: ldfld 0x04000860
    IL_000A: ldstr 0x700229AC
    IL_000B: conv.r8
    ...
    IL_0015: stloc.0
    IL_0016: ldarg.0
    IL_001B: ldfld 0x04000860
    IL_0020: ldstr 0x7002299A
    IL_0021: conv.r8
    ...
    IL_002B: stloc.0
    IL_002C: ldarg.0
    IL_0031: ldfld 0x04000860
    IL_0036: ldstr 0x700229AC
    IL_0037: conv.r8
    ...
    IL_0040: IL_3E
    IL_0041: conv.r8
    IL_0043: bgt.s IL_0044
    IL_0044: nop
    IL_0045: stloc.0
    IL_0046: ldarg.0
    IL_004B: ldfld 0x04000860
    IL_0050: ldstr 0x7002299A
    IL_0051: conv.r8
    IL_0053: bge.s IL_0054
    IL_0054: nop
    IL_0055: stloc.0
    IL_0056: IL_22
    IL_0057: IL_CD
    ...
    IL_0062: nop
    IL_0063: nop
    IL_2179F768: switch (140410304 cases)
    }

    public void LoadDir() {
    IL_0000: ldarg.0
    IL_0001: ldarg.0
    IL_0006: ldfld 0x04000850
    IL_0007: conv.r8
    IL_0008: ldc.i4.2
    IL_0009: nop
    IL_000A: nop
    IL_000B: stloc.0
    IL_000C: ldarg.0
    IL_0011: ldfld 0x0400085B
    IL_0016: call 0x0A000029
    IL_001B: stfld 0x04000851
    IL_001C: ldarg.0
    IL_001D: ldarg.0
    IL_0022: ldfld 0x04000851
    IL_0023: ldarg.0
    IL_0028: ldfld 0x0400085A
    IL_0029: conv.r8
    IL_002A: ldc.i4.2
    IL_002B: nop
    IL_002C: nop
    IL_002D: stloc.0
    IL_0032: call 0x0A000019
    IL_0037: stfld 0x04000855
    IL_0038: ldarg.0
    IL_003D: ldflda 0x04000855
    IL_003E: ldc.i4.1
    IL_003F: IL_22
    IL_0040: nop
    IL_0041: nop
    IL_0042: nop
    IL_0043: nop
    IL_0048: call 0x0A00001A
    IL_0049: ldarg.0
    IL_004E: ldfld 0x04000855
    IL_0053: call 0x0A00001B
    IL_0058: call 0x0A00001C
    IL_005D: brfalse IL_006F
    IL_005E: ldarg.0
    IL_005F: ldarg.0
    IL_0064: ldfld 0x04000855
    IL_0069: call 0x0A00001D
    IL_006E: stfld 0x04000859
    IL_006F: ret
    }

    public void SetRndPosition() {
    IL_0000: ldarg.0
    IL_0005: call 0x0A0000C1
    IL_0006: IL_22
    IL_0007: IL_CD
    IL_0008: IL_CC
    IL_0009: IL_CC
    ...
    IL_0014: stfld 0x0400085B
    IL_0015: ldarg.0
    IL_001A: ldflda 0x0400085B
    IL_001B: ldc.i4.1
    IL_001C: IL_22
    IL_001D: ldelem.i
    IL_001E: IL_99
    IL_001F: IL_99
    IL_0020: IL_3E
    IL_0025: call 0x0A00001A
    IL_0026: ldarg.0
    IL_0027: ldc.i4.0
    IL_0029: ldc.i4.s 10
    IL_002E: call 0x0A000045
    IL_0033: stfld 0x04000853
    IL_0034: ldarg.0
    IL_0039: ldfld 0x04000853
    IL_003A: ldc.i4.7
    IL_003B: IL_3F
    IL_003C: stloc.1
    IL_003D: nop
    ...
    IL_003F: nop
    IL_0040: ldarg.0
    IL_0045: ldfld 0x04000854
    IL_004A: brfalse IL_0060
    IL_004B: ldarg.0
    IL_0050: ldfld 0x04000860
    IL_0055: ldstr 0x7002299A
    IL_0056: conv.r8
    IL_0057: IL_55
    IL_0058: nop
    IL_0059: nop
    ...
    IL_005F: br IL_0070
    IL_0060: ldarg.0
    IL_0065: ldfld 0x04000860
    IL_006A: ldstr 0x700229AC
    IL_006B: conv.r8
    IL_006C: IL_55
    IL_006D: nop
    IL_006E: nop
    ...
    IL_0000: ldarg.0
    IL_0001: ldc.i4.1
    IL_0006: stfld 0x04000854
    IL_0007: ldarg.0
    IL_0008: ldc.i4.1
    IL_000D: stfld 0x0400085C
    IL_000E: ret
    }
    ...
    public void GetItem() {
    IL_0000: ldarg.0
    IL_0005: ldfld 0x04000858
    IL_000A: brtrue IL_0077
    IL_000B: ldarg.0
    IL_0010: ldfld 0x04000854
    IL_0015: brtrue IL_0077
    IL_0016: ldarg.0
    IL_0017: IL_22
    IL_0018: nop
    IL_0019: nop
    IL_001A: IL_B0
    IL_217A13: switch (548477 cases)
    }

    private void Update() {
    IL_0000: ldarg.0
    IL_0005: ldfld 0x04000854
    IL_000A: brfalse IL_0160
    IL_000B: ldarg.0
    IL_0010: ldfld 0x04000852
    IL_0011: IL_22
    IL_0012: nop
    IL_0013: nop
    IL_0014: nop
    ...
    IL_001A: nop
    IL_001B: ldarg.0
    IL_0020: ldfld 0x0400085A
    IL_0021: ldarg.0
    IL_0026: ldfld 0x0400085A
    IL_0027: conv.r8
    IL_0028: ldc.i4.2
    IL_0029: nop
    IL_002A: nop
    ...
    IL_004F: call 0x0A000024
    IL_0050: IL_22
    IL_0051: nop
    IL_0052: nop
    IL_0053: IL_C0
    IL_18CA1C0: switch (6498394 cases)
    }
