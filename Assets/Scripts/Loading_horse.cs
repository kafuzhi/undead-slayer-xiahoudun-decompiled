...
// Type: Loading_horse
    ...
    public Loading_horse() {
    IL_0000: ldarg.0
    IL_0001: ldc.i4.5
    IL_0006: newarr 0x01000001
    IL_000B: stfld 0x040007BD
    IL_000C: ldarg.0
    ...
    IL_000B: stfld 0x040007BA
    IL_000C: ldarg.0
    IL_0011: call 0x0A00002A
    IL_0016: ldstr 0x70000DA5
    IL_0017: conv.r8
    IL_0019: bge.s IL_001A
    IL_001A: nop
    IL_001B: stloc.0
    IL_001C: IL_22
    IL_001E: bne.un.s IL_0052
    IL_0020: bne.un.s IL_0060
    IL_0021: conv.r8
    ...
    IL_0035: stloc.0
    IL_0036: pop
    IL_003B: ldstr 0x7000174B
    IL_0040: call 0x06000220
    IL_0041: stloc.0
    IL_0042: ldarg.0
    IL_0047: ldstr 0x70000BDB
    IL_004C: call 0x06000220
    IL_0051: stfld 0x040007BE
    IL_0052: ldarg.0
    IL_0057: ldfld 0x040007BC
    IL_0058: conv.r8
    IL_0059: stloc.3
    IL_005A: nop
    IL_005B: nop
    ...
    private void Start() {
    IL_0004: newobj 0x06000767
    IL_0005: stloc.0
    IL_0006: ldloc.0
    IL_0007: ldarg.0
    IL_000C: stfld 0x04001050
    IL_000D: ldloc.0
    IL_000E: ret
    }
    ...
    IL_0030: stloc.0
    IL_0032: ldloca.s 0
    IL_0037: ldfld 0x0A00005C
    IL_0038: IL_22
    IL_003A: bne.un.s IL_006E
    IL_003B: stelem.i
    IL_1654C: switch (22851 cases)
    }
