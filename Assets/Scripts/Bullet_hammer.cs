...
// Type: Bullet_hammer
    ...
    IL_000B: stfld 0x040001AF
    IL_000C: ldarg.0
    IL_000D: ldarg.0
    IL_0012: call 0x0A00000D
    IL_0017: stfld 0x040001B6
    IL_0018: ldarg.0
    IL_0019: ldarg.0
    IL_001E: call 0x0A000003
    IL_0023: stfld 0x040001B7
    IL_0024: ret
    }

    private void OnEnable() {
    IL_0000: ldarg.0
    IL_0005: ldfld 0x040001AF
    IL_0006: ldarg.0
    IL_000B: ldfld 0x040001B1
    IL_000C: conv.r8
    IL_000D: IL_AF
    IL_000E: nop
    IL_000F: nop
