...
// Type: Mon_Destroy
    ...
    IL_0025: stfld 0x04000803
    IL_0026: ldarg.0
    IL_002B: call 0x0A00000A
    IL_002C: ldc.i4.0
    IL_002D: conv.r8
    IL_002E: stloc.1
    IL_002F: nop
    ...
    IL_002B: nop
    IL_002C: nop
    IL_0031: stfld 0x04000805
    IL_0032: ldarg.3
    IL_0033: ldc.i4.2
    IL_0334: switch (191 cases)
    }

    private void Update() {
    IL_0000: ldarg.0
    IL_0005: ldfld 0x04000804
    IL_0006: IL_22
    IL_0007: nop
    IL_0008: nop
    IL_D90D0D: switch (3556160 cases)
    }
